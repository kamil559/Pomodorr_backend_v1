...
)  # (pomodorr/config/settings/base.py - 3 = pomodorr/)
APPS_DIR = ROOT_DIR.path("pomodorr")
...
MIGRATION_MODULES = {"sites": "pomodorr.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "pomodorr.tools.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Kamil Daniewski""", "kamil.daniewski@gmail.com")]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'pomodorr.auth.auth_classes.CustomJSONWebTokenAuthentication',
        'rest_framework.authentication.TokenAuthentication',
    ),
